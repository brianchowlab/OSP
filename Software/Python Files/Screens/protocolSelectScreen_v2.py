...
# self implementation generated from reading ui file 'protocolSelectScreen_v2.ui'
#
...
class protocolSelectScreen(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 781, 448))
...
"font: 75 20pt \"Roboto\";"))
        ...
        self.shake_button = QtGui.QPushButton(self.layoutWidget)
        self.shake_button.setMinimumSize(QtCore.QSize(200, 50))
        self.shake_button.setStyleSheet(_fromUtf8("background-color: rgb(255, 191, 88);\n"
"font: 75 20pt \"Roboto\";"))
        self.shake_button.setObjectName(_fromUtf8("shake_button"))
        self.horizontalLayout_7.addWidget(self.shake_button)
        spacerItem1 = QtGui.QSpacerItem(38, 18, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
...
"font: 75 14pt \"Roboto\";"))
        ...
        spacerItem8 = QtGui.QSpacerItem(400, 35, QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Minimum)
...
"font: 75 14pt \"Roboto\";"))
    ...
    def retranslateUi(self):
        ...
        self.shake_button.setText(_translate("self", "Shaking", None))
