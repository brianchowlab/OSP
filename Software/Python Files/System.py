...
class System(object):
    ...
    def load_calibration_data(self, platetype, filename=''):
        """This function loads in the calibration data collected from a previous calibration.
        Calibration data is stored in the System Settings directory as a pickle file. 
        
        Arguments:
            platetype {integer} -- possible values are either 24 (for a 24-well plate) or 96 (for a 96-well plate).
        
        Keyword Arguments:
            filename {str} -- filename of the calibration data to be imported. (default: {''})
        """
    ...
    def set_plate_type(self, platetype):
        ...
        Arguments:
            platetype {integer} -- possible value of 24 (for 24-well plate) or 96 (for 96-well plate)
        """
